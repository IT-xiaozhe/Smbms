...
<div class="right">
       ...
       <form method="get" action="${pageContext.request.contextPath }/bill/billList">
			...
			<select name="queryIsPayment">
			 ...
			 <a href="${pageContext.request.contextPath }/bill/addJsp">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="/bill/lookJsp?billid=${bill.id }&billcc=${bill.billCode }"><img src="${pageContext.request.contextPath }/static/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyBill" href="/bill/updateJsp?billid=${bill.id }&billcc=${bill.billCode }"><img src="${pageContext.request.contextPath }/static/images/xiugai.png" alt="修改" title="修改"/></a></span>
