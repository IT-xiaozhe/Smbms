                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					<tr>
						...
						<td>
						<span><a class="viewUser" href="/user/look?userid=${user.id }&username=${user.userName }"><img src="${pageContext.request.contextPath }/static/images/read.png" alt="查看" title="查看"/></a></span>
						<span><a class="modifyUser" href="/user/update?userid=${user.id }&username=${user.userName }"><img src="${pageContext.request.contextPath }/static/images/xiugai.png" alt="修改" title="修改"/></a></span>
