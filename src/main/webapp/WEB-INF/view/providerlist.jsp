...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/proList">
				...
				<a href="${pageContext.request.contextPath }/provider/addJsp">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewProvider" href="/provider/lookJsp?proid=${provider.id }&proname=${provider.proName }"><img src="${pageContext.request.contextPath }/static/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyProvider" href="/provider/updateJsp?proid=${provider.id }&proname=${provider.proName }"><img src="${pageContext.request.contextPath }/static/images/xiugai.png" alt="修改" title="修改"/></a></span>
